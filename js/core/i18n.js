...
export const TRANSLATIONS = {
  ca: {
    ...
    temp_pwd_msg: 'Aquesta és la contrasenya temporal de {name}. Fes-l\'hi arribar: amb la que tenia abans ja no pot entrar.',
  ...
  es: {
    ...
    temp_pwd_msg: 'Esta es la contraseña temporal de {name}. Hazla llegar al socio: con la que tenía antes ya no puede entrar.',
